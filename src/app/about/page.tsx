          ...
          <section className="mb-16">
            <div className="bg-light-gray rounded-lg p-8">
              ...
              <div className="bg-white bg-opacity-10 p-6 rounded-lg">
                ...
                <p className="text-gray-700"><strong>Email:</strong> <a href="mailto:myyspacefurniture@gmail.com" className="text-[#b8845c] hover:text-white hover:bg-[#b8845c] rounded px-2 py-1 transition">myyspacefurniture@gmail.com</a></p>
              </div>
            </div>
          </section>
        </div>
