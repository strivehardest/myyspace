...
export default function Mattresses() {
  ...
  const handlePrev = () => setCurrent((prev) => (prev === 0 ? mattressImages.length - 1 : prev - 1));
  const handleNext = () => setCurrent((prev) => (prev === mattressImages.length - 1 ? 0 : prev + 1));
